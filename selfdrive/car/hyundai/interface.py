...
class CarInterface(CarInterfaceBase):
  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), has_relay=False, car_fw=[]):  # pylint: disable=dangerous-default-value
    ...
    if candidate == CAR.SANTA_FE:
      ...
      ret.lateralTuning.indi.outerLoopGain = 3.2 # 3.0 2.8 was 3.0 - good. kinda twitchy 3.5 was 4.05 2.0 outer and inner are gains. Higher values = more steering
      ...
      ret.lateralTuning.indi.actuatorEffectiveness = 0.7 #0.9 was 1.2. 1.2 was 1.1 - almost good, tad too much power 1.45 1.62 was 1.5 how much it steers. Lower values == more steering
      ret.steerActuatorDelay = 0.16 # 0.2, tad too early steer .52 0.53 was 0.56 was 0.52 was 0.6 - 0.08 on tunder
      ret.steerLimitTimer = 0.2 #best working so far in the entire group was 0.4 stock is 0.01, 0.4 works well, trying 0.2, 0.1 for quicker turn in.  0.1 is strong on highway, notchy in town
